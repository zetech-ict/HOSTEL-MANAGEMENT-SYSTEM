						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-primary">
									<div class="panel-heading">Fill Info below</div>
									<div class="panel-body">
										<form method="post" action="" class="form-horizontal">
											
										
<div class="form-group">
<label class="col-sm-4 control-label"><h4 style="color: blue" align="left">Room Related info </h4> </label>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label"><h4 style="color: blue" align="left">Personal info </h4> </label>
</div>
