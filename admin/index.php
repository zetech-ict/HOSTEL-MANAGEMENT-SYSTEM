...
<body>
	...
	<div class="login-page bk-img" style="background-image: linear-gradient(grey,pink);">
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									...
									<label for="" class="text-lowercase a2 ">Your Username or Email</label>
									<input type="text" placeholder="Username" name="username" class="form-control mb" required>

									<label for="" class="text-lowercase a2">Password</label>
									<input type="password" placeholder="Password" name="password" class="form-control mb" required>

									<div class="text-center text-light" style="color:blue;">

							<a href="./forgotpassword.php" style="color:blue;">Forgot password?</a><br>
					</div>
